    ...
    <div className="container">
      ...
      <div className="row text-muted align-items-center" style={{ lineHeight: "1.8", fontSize: "16px" }}>
        ...
        <div className="col-lg-6 col-md-12 p-5">
          <p>
            Nishita bootstrapped and founded Stockflow in 2026 to overcome the hurdles she faced during her decade-long stint as a trader.
            Today, StockFlow has changed the landscape of the Indian broking industry.
          </p>
          <p>
